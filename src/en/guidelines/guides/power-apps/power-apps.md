...
- Access to the <sbb-link variant="inline" type="button" target="_blank" href="https://sbb.sharepoint.com/sites/power-platform-infocenter/SitePages/Power-App-Template-1.aspx">components</sbb-link> in the SBB look & feel (buttons, accordions, input fields etc.) {.lead}  
...
<sbb-link variant="inline" type="button" target="_blank" href="https://sbb.sharepoint.com/sites/power-platform-infocenter/SitePages/Power-App-Template-1.aspx">Using</sbb-link> the SBB power apps template  {.lead}  
...
- <sbb-link variant="inline" type="button" target="_blank" href="https://sbb.sharepoint.com/sites/power-platform-infocenter/SitePages/Power-App-Template-1.aspx">Instruction on how to install the SBB power apps template</sbb-link>
