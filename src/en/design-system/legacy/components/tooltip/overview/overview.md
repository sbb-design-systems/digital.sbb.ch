...
* A link may open content in a <sbb-link variant="inline" href="/{{page.lang}}/design-system/legacy/components/dialog">lightbox</sbb-link> or on a new page (new tab). It cannot be loaded in the current browser window.{.lead}
