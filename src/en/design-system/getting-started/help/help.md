...
- <sbb-link variant="inline" type="button" target="_blank" href="https://github.com/lyne-design-system/lyne-components/issues?q=is%3Aissue+label%3A%22type%3A+question+❓%22+">Questions on the Lyne Board</sbb-link>
...
## Contact 
Higher-level, generic and UX questions to: <sbb-link variant="inline" type="button" href="mailto:ux@sbb.ch">ux@sbb.ch</sbb-link>.{.lead}

Technical questions or questions about components/patterns can be posted via Github on the respective board: {.lead}
- <sbb-link variant="inline" type="button" target="_blank" href="https://github.com/lyne-design-system/lyne-components/issues/new?assignees=octocat&labels=type%3A+question+❓&template=question.yml&title=%5BQuestion%5D%3A+">Submit a question to the Lyne Board</sbb-link>
