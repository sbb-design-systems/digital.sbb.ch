...
A design system can and should grow, but there are certain constraints. See <sbb-link  type="button" href="/{{page.lang}}/design-system/organization/contributing/">Contribution</sbb-link> for more information on this. {.lead}
...
Try our <sbb-link  type="button" href="/{{page.lang}}/design-system/getting-started/faq/">FAQ</sbb-link> page.
If you don't find what you are looking for, please feel free to <sbb-link  type="button" href="mailto:ux@sbb.ch">contact</sbb-link> us. {.lead}