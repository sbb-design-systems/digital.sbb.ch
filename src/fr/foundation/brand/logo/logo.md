...
En principe, les directives sur les logos et les emblèmes disponibles sur le <sbb-link  type="button" target="_blank" href="https://brand.sbb.ch/document/4">portail de la marque CFF</sbb-link> s’appliquent. {.lead}
...
Exemples:
- <sbb-link  type="button" href="/{{page.lang}}/design-system/mobile/components/header/">En-tête d’une application mobile</sbb-link>
- <sbb-link  type="button" href="/{{page.lang}}/guidelines/regulations/app-icons/">icônes d’applications mobiles</sbb-link>