...
Das kann gut sein. Wir sind um jeden Hinweis froh und korrigieren Fehler/Unvollständigkeiten gerne. Sollte sich ein Fehler auf dieser Plattform eingeschlichen habebn, so kannst du ein Mail an <sbb-link  href="mailto:ux@sbb.ch">ux@sbb.ch</sbb-link> schreiben. Ist die Dokumention auf Github oder <sbb-link  href="https://angular.app.sbb.ch" target="_blank">angular.app.sbb.ch</sbb-link> fehlerhaft, so bitten wir dich ein <sbb-link  href="/{{page.lang}}/design-system/organisation/contributing/">Issue (Bug Report)</sbb-link> zu eröffnen. 
