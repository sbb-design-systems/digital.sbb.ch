...
title: Übersicht
key: timefield-legacy-overview_de
...
Immer wenn vom Benutzer eine Uhrzeit verlangt wird.{.lead}
...
* Bei Touch-Geräten erscheint die Zahlen-Eingabetastatur des entsprechenden Systems.{.lead}