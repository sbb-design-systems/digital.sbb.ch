...
- Zugriff auf die <sbb-link variant="inline" type="button" target="_blank" href="https://sbb.sharepoint.com/sites/power-platform-infocenter/SitePages/Power-App-Template-1.aspx">Komponenten</sbb-link> im SBB Look & Feel (Buttons, Akkordions, Inputfelder etc.) {.lead}  
...
Die SBB Power Apps Vorlage <sbb-link variant="inline" type="button" target="_blank" href="https://sbb.sharepoint.com/sites/power-platform-infocenter/SitePages/Power-App-Template-1.aspx">verwenden</sbb-link>. {.lead}  
...
- <sbb-link variant="inline" type="button" target="_blank" href="https://sbb.sharepoint.com/sites/power-platform-infocenter/SitePages/Power-App-Template-1.aspx">Anleitung zur Installation von SBB Power Apps Vorlage</sbb-link>
