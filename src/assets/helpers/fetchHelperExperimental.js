...
const generateUrl = (specificPath) => {
  return `${version.url}${version.branch}${version.pathexperimental}${specificPath}${version.dok}`;
};

// Fetch-Daten von der generierten URL
const fetchDataExperimental = async (specificPath) => {
...
module.exports = fetchDataExperimental;