module.exports = {
  ...
  en: {
    ...
    lyne: {
      ...
      "multipleoption": "Multiple options selectable",
      "multi": "Allow multiple opened items",
  ...
  de: {
    ...
    lyne: {
      ...
      "alignment": "Anordnung",
      "after": "Danach",
      "after-centered": "Danach, zentriert",
      "below": "Darunter",
      "amount": "Anzahl",
      "appearance": "Aussehen",
      ...
      "multipleoption": "Mehrere Optionen selektierbar",
      "multi": "Mehrere geöffnete Items erlauben",
      "multi-select": "Mehrere Tage anwählbar",
      "name": "Icon",
      "negative": "Negativ",
      "never": "Nie",
  ...
  fr: {
    ...
    menu: "Menu",
    close: "Fermer",
    newwindow: "Ouvre dans un nouvel tab.",
    selectlanguage: "Sélection de la langue",
    mainnavigation: "Navigation générale",
    time: "Heure actuelle",
    ...
    homelink: "Retour à la page home",
  ...
  it: {
    ...
    selectlanguage: "Selezione della lingua",
