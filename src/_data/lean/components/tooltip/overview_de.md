...
* Im Overlay dürfen nur Freitext und <sbb-link  type="button" href="/{{page.lang}}/design-system/lean/components/link/">Links</sbb-link> eingesetzt werden. Der Text darf auch als Liste dargestellt werden. {.lead}
