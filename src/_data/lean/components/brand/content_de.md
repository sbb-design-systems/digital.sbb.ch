...
## Regeln
* Das Logo tritt genau einmal pro Seite auf und befindet sich immer im <sbb-link  type="button" href="/{{page.lang}}/design-system/lean/components/header/">Header</sbb-link>. {.lead}
