...
## Rules
* The logo appears exactly once per page and is always located in the <sbb-link  type="button" href="/en/design-system/lean/components/header/">header</sbb-link>. {.lead}
