...
## Regeln 
* Mit Klick auf den <sbb-link  type="button" href="/{{page.lang}}/design-system/lean/components/button/">Button</sbb-link> «Datei hochladen» öffnet sich der Datei-Browser des Systems. {.lead}
...
* Der Datei-Upload hat über dem <sbb-link  type="button" href="/{{page.lang}}/design-system/lean/components/button/">Button</sbb-link> immer einen Hinweis, welche Dateitypen und -grössen hochgeladen werden können. {.lead}
