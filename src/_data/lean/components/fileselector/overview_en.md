...
## Rules 
* The system’s file browser opens when the ‘upload file’ <sbb-link  type="button" href="/en/design-system/lean/components/button/">button</sbb-link> is clicked. {.lead}
...
* The file upload always indicates above the <sbb-link  type="button" href="/en/design-system/lean/components/button/">button</sbb-link>  which file types and sizes can be uploaded. {.lead}