...
Beim Hover über einen Icon Button sollte ein <sbb-link  type="button" href="/{{page.lang}}/design-system/lean/components/tooltip/">Tooltip</sbb-link> verwendet werden, um die dahinterliegende Aktion klarer zu machen. {.lead}
