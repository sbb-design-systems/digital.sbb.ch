...
When hovering over an icon button, a <sbb-link  type="button" href="/en/design-system/lean/components/tooltip/">tooltip</sbb-link>  should be used to make the underlying action clearer. {.lead}
