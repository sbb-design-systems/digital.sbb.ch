## Verwendung
Icons dienen zur visuellen Unterstützung von Themen und Aktionen. Für die Verwendung in SBB-Anwendungen sind die Icons im SBB-Stil einzusetzen. Details dazu und ein Set an bereits verfügbaren Icons sind <sbb-link  type="button" href="/{{page.lang}}/foundation/assets/icons/">hier</sbb-link> zu finden. {.lead}
