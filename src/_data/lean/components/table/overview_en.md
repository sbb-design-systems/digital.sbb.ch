...
* Large amounts of data can be divided up using <sbb-link  type="button" href="/en/design-system/lean/components/pagination/">pagination</sbb-link>. Alternatively, infinite scrolling can be used if required. {.lead}
