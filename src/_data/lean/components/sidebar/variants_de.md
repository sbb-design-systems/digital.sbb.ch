...
* Bei den Kategorien kann beim Einsatz der Sidebar zwischen <sbb-link  type="button" href="/{{page.lang}}/design-system/lean/components/accordion/">Accordion</sbb-link> und <sbb-link  type="button" href="/{{page.lang}}/design-system/lean/components/fieldset/">Fieldset</sbb-link> gewählt werden. {.lead}
