...
* For the categories you can choose between <sbb-link  type="button" href="/en/design-system/lean/components/accordion/">accordion</sbb-link> and <sbb-link  type="button" href="/en/design-system/lean/components/fieldset/">fieldset</sbb-link> when using the sidebar. {.lead}
