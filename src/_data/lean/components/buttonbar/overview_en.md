...
* No more than three <sbb-link  type="button" href="/en/design-system/lean/components/button/">buttons</sbb-link>  may be placed. If more actions are necessary, then a <sbb-link  type="button" href="/en/design-system/lean/components/contextmenu/">contextmenu</sbb-link> should be used. This is placed to the right of the other buttons. {.lead}
