...
* Wenn die Inhalte der verschiedenen Aspekte nicht gleichzeitig von den Benutzer*innen angesehen werden müssen. {.lead}
...
* Falls die Register für den Viewport zu lang sind, wird die Breite verkürzt und die Bezeichungen werden mit «...» abgeschnitten. Ein Hover über den Tab blendet den kompletten Namen in einem <sbb-link  type="button" href="/{{page.lang}}/design-system/lean/components/tooltip/">Tooltip</sbb-link> ein. {.lead}
