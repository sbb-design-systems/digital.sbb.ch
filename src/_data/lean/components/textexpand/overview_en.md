...
* Apart from the <sbb-link  type="button" href="/en/design-system/lean/components/link/">link</sbb-link> ‘show less’, no further interaction elements can be used when expanded. {.lead}
