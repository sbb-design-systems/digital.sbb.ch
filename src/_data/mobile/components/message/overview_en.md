...
## Rules
* Field validations (e.g. for the <sbb-link  type="button" href="/{{page.lang}}/design-system/mobile/components/text-input/">text input</sbb-link>) are used for incorrect entries.
